...
describe('Zenith routes', function (): void {
    it('registers concrete interface routes under the Horizon boundary', function (): void {
        $expected = [
            ...
            'zenith.failed-jobs.retry-selected.store' => ['POST', 'horizon/failed/retry-selected'],
            'zenith.failed-jobs.selected.destroy' => ['DELETE', 'horizon/failed/selected'],
            ...
            'zenith.schedule.dynamic-crons.store' => ['POST', 'horizon/schedule/dynamic-crons'],
            'zenith.schedule.dynamic-crons.update' => ['PUT', 'horizon/schedule/dynamic-crons/{cron}'],
            'zenith.schedule.dynamic-crons.destroy' => ['DELETE', 'horizon/schedule/dynamic-crons/{cron}'],
            'zenith.schedule.dynamic-crons.pause.store' => ['POST', 'horizon/schedule/dynamic-crons/{cron}/pause'],
            'zenith.schedule.dynamic-crons.pause.destroy' => ['DELETE', 'horizon/schedule/dynamic-crons/{cron}/pause'],
