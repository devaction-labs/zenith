...
final class DashboardSummaryData extends Data
{
    ...
    public function __construct(
        ...
        public readonly int $recentlyFailedJobs,
        public readonly int $recentlyFailedPeriodMinutes,
        public readonly int|float $jobsPerMinute,
        public readonly int $recentJobs,
        public readonly int $recentJobsPeriodMinutes,
        public readonly int $processedSinceSnapshot,
